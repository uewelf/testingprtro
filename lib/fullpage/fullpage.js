! function(e, t, n, o, r) {
    ...
    function Dn(e, t) {
        return e && 1 === e.nodeType ? Kn(e, t) ? e : Dn(e.parentNode, t) : null
    }
    ...
    function a(e, t, n) {
        for (var o = e[n], r = []; o;)(Kn(o, t) || null == t) && r.push(o), o = o[n];
        return r
    }
    ...
    return Rt.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(e, t) {
        ...
        function(e, E) {
            ...
            if (!yn(u, Wt)) {
                ...
                Ot(), Rt.fp_easings = wn(Rt.fp_easings, {
                    ...
                    J(!1, "internal"), oe(!0), re(!1), ie(!1), In(d, Vt), [y, w, S, k, O, C, b].forEach(function(e) {
                        ...
                        t && e.setAttribute("style", e.getAttribute("data-fp-styles")), yn(e, _t) && !D && e.removeAttribute("data-anchor")
                        ...
                        transition: "none"
                    }), Rt.scrollTo(0, 0), [_t, nn, sn].forEach(function(e) {
                        Rn(bn("." + e), e)
                    }))
                    ...
                    xn(d, {
                        height: "100%",
                        position: "relative"
                    }), In(d, zt), In(u, Wt), A = En(), Rn(d, Vt), In(bn(E.sectionSelector, d), _t), In(bn(E.slideSelector, d), nn);
                    for (var e = bn(Kt), t = 0; t < e.length; t++) {
                        var n = t,
                            o = e[t],
                            r = bn(on, o),
                            i = r.length;
                    ...
                    E.fixedElements && E.css3 && bn(E.fixedElements).forEach(function(e) {
                        ...
                        for (var o = "", r = 0; r < bn(Kt).length; r++) {
                            var i = "";
                        ...
                        }), In(bn("a", bn("li", bn(en)[0])[Cn(bn($t)[0], Kt)]), Ft)
                ...
                }(), oe(!0), re(!0), J(E.autoScrolling, "internal"), at(), yt(), "complete" === Nt.readyState && Ke(), Rt.addEventListener("load", Ke), E.scrollOverflow || ye(), function() {
            ...
            function le() {
                var e = An(bn($t)[0], Kt);
                e || !E.loopTop && !E.continuousVertical || (e = Mn(bn(Kt))), null != e && Ie(e, null, !0)
            }

            function ae() {
                var e = Tn(bn($t)[0], Kt);
                e || !E.loopBottom && !E.continuousVertical || (e = bn(Kt)[0]), null != e && Ie(e, null, !1)
            }
            ...
            function de(e) {
                if (!yn(d, Vt)) {
                    g = !0, A = En(), s = Ln();
                    for (var t = bn(Kt), n = 0; n < t.length; ++n) {
                        var o = t[n],
                            r = bn(an, o)[0],
                            i = bn(on, o);
            ...
            function he(e) {
                ...
                t && Dn(t, en + " a") ? function(e) {
                    ...
                    Ie(bn(Kt)[t])
                }.call(t, e) : Kn(t, ".fp-tooltip") ? function() {
                    _n(kn(this), "click")
                }.call(t) : Kn(t, pn) ? function() {
                    var e = Dn(this, Kt);
                    yn(this, hn) ? p.m.left && fe(e) : p.m.right && ue(e)
                }.call(t, e) : Kn(t, vn) || null != Dn(t, vn) ? function(e) {
                    Un(e);
                    var t = bn(an, Dn(this, Kt))[0],
            ...
            function be(e, t, n) {
                ...
                var c = bn(rn, e)[0];
                null != c && (0 !== Cn(bn($t), Kt) || 0 === Cn(bn($t), Kt) && 0 !== Cn(c)) ? Lt(c, "internal") : In(t[0], Ft)
            }
            ...
            function Te(e) {
                var t = Dn(e.target, Kt) || bn($t)[0];
                if (ke(e)) {
                    E.autoScrolling && Un(e);
                    var n = Et(e);
                    _ = n.y, K = n.x, bn(an, t).length && Math.abs(X - K) > Math.abs(U - _) ? !a && Math.abs(X - K) > Ln() / 100 * E.touchSensitivity && (K < X ? p.m.right && ue(t) : p.m.left && fe(t)) : E.autoScrolling && T && Math.abs(U - _) > Rt.innerHeight / 100 * E.touchSensitivity && (_ < U ? xe("down") : U < _ && xe("up"))
                }
            }
            ...
            function Ie(e, t, n) {
                if (null != e) {
                    var o, r, i, l, a, s, c, u, f, d = {
                        ...
                        sectionIndex: Cn(e, Kt),
                        activeSlide: bn(rn, e)[0],
                        activeSection: bn($t)[0],
                        leavingSection: Cn(bn($t), Kt) + 1,
                        localIsResizing: g
                    };
                    if (!(d.activeSection == e && !g || E.scrollBar && Yn() === d.dtop && !yn(e, Gt))) {
                        ...
                        E.autoScrolling && E.continuousVertical && void 0 !== d.isMovementUp && (!d.isMovementUp && "up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && ((p = d).isMovementUp ? Wn(bn($t)[0], Gn(p.activeSection, Kt)) : Vn(bn($t)[0], Jn(p.activeSection, Kt).reverse()), xt(bn($t)[0].offsetTop), He(), p.wrapAroundElements = p.activeSection, p.dtop = p.element.offsetTop, p.yMovement = ft(p.element), d = p), d.localIsResizing || Xe(d.activeSection), E.scrollOverflow && E.scrollOverflowHandler.beforeLeave(), In(e, Ft), Rn(Fn(e), Ft), We(e), E.scrollOverflow && E.scrollOverflowHandler.onLeave(), T = h.test.isTesting, St(f, u, d.anchorLink, d.sectionIndex),
                            function(e) {
            ...
            function Re(e, t) {
                ...
                } else if (_n(d, e, l), !1 === E[e].apply(l[Object.keys(l)[0]], (n = l, Object.keys(n).map(function(e) {
                        return n[e]
                    })))) return !1;
                return !0
            }
            ...
            function Pe(e) {
                var t;
                null != (t = e).wrapAroundElements && (t.isMovementUp ? Wn(bn(Kt)[0], t.wrapAroundElements) : Vn(bn(Kt)[bn(Kt).length - 1], t.wrapAroundElements), xt(bn($t)[0].offsetTop), He()), Xn(E.afterLoad) && !e.localIsResizing && Re("afterLoad", e), E.scrollOverflow && E.scrollOverflowHandler.afterLoad(), e.localIsResizing || Fe(e.element), In(e.element, Xt), Rn(Fn(e.element), Xt), Ve(), T = !0, Xn(e.callback) && e.callback()
            }
            ...
            function Ve() {
                ...
                E.lazyLoading && e && bn(Kt + ":not(" + Ut + ")").forEach(function(e) {
                    var t, n, o;
            ...
            function We(o) {
                E.lazyLoading && bn("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]", _e(o)).forEach(function(n) {
            ...
            function Qe(e) {
                ...
                9 === n ? function(e) {
                    ...
                    }(t = e, n = et(Nt), o = n.indexOf(Nt.activeElement), r = t.shiftKey ? o - 1 : o + 1, i = n[r], l = ze(Dn(i, on)), a = Ne(Dn(i, Kt)), l || a) && (c ? null == Dn(c, $t + "," + $t + " " + rn) && (c = f(e)) : f(e), (!s && c == u[u.length - 1] || s && c == u[0]) && Un(e))
                }(e) : Kn(t, "textarea") || Kn(t, "input") || Kn(t, "select") || "true" === t.getAttribute("contentEditable") || "" === t.getAttribute("contentEditable") || !E.keyboardScrolling || !E.autoScrolling || (-1 < [40, 38, 32, 33, 34].indexOf(n) && Un(e), c = e.ctrlKey, M = setTimeout(function() {
                    ! function(e) {
                        var t = e.shiftKey,
                            n = Nt.activeElement,
                            o = Kn(n, "video") || Kn(n, "audio");
            ...
            function lt() {
                if (at(), o) {
                    ...
                    if (!Kn(e, "textarea") && !Kn(e, "input") && !Kn(e, "select")) {
                        var t = En();
